 ...
 * The Shortcode
 */
function novafw_portfolio_shortcode( $atts ) {
	extract( 
		shortcode_atts( 
			array(
				'type' => 'full-grid-3col',
...
?>
	...
	<?php if( 'full-grid-3col' == $type ) : ?>
		...
		<section class="projects p__0 bg-dark">
	...
	<?php elseif( 'preview-2col' == $type ) : ?>
		...
		<section class="projects bg-secondary p__0 pt__64 preview-portfolio">
	...
	<?php elseif( 'full-grid-3col-no-hover' == $type ) : ?>
		...
		<section class="projects p__0 bg-dark no-hover">
	...
	<?php elseif( 'preview-2col-no-hover' == $type ) : ?>
		...
		<section class="projects bg-secondary p__0 pt__64 preview-portfolio no-hover">
...
add_shortcode( 'thebear_portfolio', 'novafw_portfolio_shortcode' );

/**
 * The VC Functions
 */
function novafw_portfolio_shortcode_vc() {
	
	$portfolio_types = novafw_get_portfolio_layouts();
	
	vc_map( 
		array(
			"icon" => 'thebear-vc-block',
			"name" => esc_html__("Portfolio", 'thebear'),
			"base" => "thebear_portfolio",
			...
			"params" => array(
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Show Filters?", 'thebear'),
...
add_action( 'vc_before_init', 'novafw_portfolio_shortcode_vc');